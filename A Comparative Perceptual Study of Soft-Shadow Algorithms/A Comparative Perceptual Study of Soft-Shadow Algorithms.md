...
その実験は同じ純粋に人工的な光条件を保証するために窓を閉め切った部屋で行われた。平均で、その実験は非専門家に対して46分、専門家に対して62分かかった(regeneration breaksを含めず)。十分なレベルの意欲を保証するため、各被験者には報酬[reimbursement]が支払われた。その実験は(短い休憩[recreational breaks]を挟まれた)3つのフェーズに分けられ、それぞれは合計で91回の試験から成る([@fig:5]を参照)。
