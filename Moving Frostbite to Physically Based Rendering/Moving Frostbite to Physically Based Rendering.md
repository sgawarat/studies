...
![電球のパッケージに見られる色温度と光量はFrostbiteに直接持ってゆくことができる。](assets/Figure16.png)
...
"ライト強度"は各ライトタイプごとに示される。色温度と強度の両方を用いることで、アーティストはリファレンス値をメーカーのウェブサイトから拾ってきて、Frostbiteに直接突っ込むことができるようになる。
