...
maskingとshadowingは出射方向と入射方向が近い場合でも強い相関がある。一般的には、$\omega_o = \omega_i$のとき、maskingとshadowingは、方向$\omega_o$から見えるマイクロファセットは方向$\omega_i$からも見えるため、完全な相関を持つ。この場合、shadowingは、影になっているマイクロファセットは方向$\omega_i$から見えず、ゆえに、方向$\omega_o$からも見えないので、BRDFから取り除かれるべきである。これは、...
