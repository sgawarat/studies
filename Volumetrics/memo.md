...
- 光の波長よりも小さい粒子によって起こる散乱
  - 空が青く見えることを説明できる

### Mie散乱

- 光の波長よりも大きい粒子によって起こる散乱
  - 雲が白く見えることを説明できる
...
- 近年のボリューメトリックライティング手法としてよく採用される[@Wronski2014; @Hillaire2015; @Lagarde2018]
- 錐台に並行な3Dテクスチャに格納したライティング結果を用いてレンダリングを行う
  - そのときのボクセルをfroxelと呼ぶ
- 主に4つの工程から成る
  1. 関与媒質の特性を混ぜ合わせてfroxelの特性を作る
     - ボリュームをボクセル化する
  2. froxelの特性からライティングを計算する
     - 散乱光の総和と透過率を計算する
  3. 前のフレームの結果をブレンドする
  4. 表面に適用する
     - 表面の錐台内の位置からライティング結果を取り出して用いる
